...
<html>
    ...
    <body>
        ...
        <div class="x-body">
            <xblock><button class="layui-btn layui-btn-danger" onclick="delAll()"><i class="layui-icon">&#xe640;</i>批量删除</button><button class="layui-btn" onclick="banner_add('添加用户','admin.php?c=ImgText&a=add','600','500')"><i class="layui-icon">&#xe608;</i>添加</button><span class="x-right" style="line-height:40px">共有数据：88 条</span></xblock>
                ...
                <tbody id="x-img">
                    <tr>
                        ...
                        <td class="td-manage">
                            ...
                            <a title="编辑" href="javascript:;" onclick="img_edit('编辑','admin.php?c=ImgText&a=edit','4','','510')"
        ...
        <script>
            ...
            // 编辑
            function img_edit (title,url,id,w,h) {
                x_admin_show(title,url,w,h); 
            }
            /*删除*/
