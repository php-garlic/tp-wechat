...
<html>
    ...
    <body>
        ...
        <script src="/tp-wechat/Public/templates/admin/lib/layui/layui.js" charset="utf-8">
        </script>
        <script src="/tp-wechat/Public/templates/admin/js/x-layui.js" charset="utf-8">
        </script>
        <script>
            layui.use(['form','layer'], function(){
              ...
              form.on('submit(save)', function(data){
                ...
                //发异步，把数据提交给php
                $.ajax({
                    url:"/tp-wechat/admin.php?c=Text&a=update",
                    type:'post',
                    datatype:'json',
                    data:{
                        'id':data.field.id,
